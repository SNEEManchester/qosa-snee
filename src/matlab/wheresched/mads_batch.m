...
Problem.File.F = 'wheresched';               % functions file
Problem.File.O = 'wheresched_Omega';         % linear constraints file
Problem.File.X = 'wheresched_X';             % closed constraints file
Problem.File.I = 'wheresched_x0';            % initial points file
Problem.File.N = 'wheresched_N';             % discrete neighbor file (MVP only)
Problem.File.P = '';         % parameter file	
Problem.File.C = '';     % previously created Cache file
Problem.File.S = '';   % previously created Session file
Problem.File.H = '';   % iteration history text file
Problem.File.D = '';     % debug log file
