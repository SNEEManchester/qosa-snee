...
if ~isequal(size(l),size(u)) || any(l > u) 
...
%Ixent has changed this.. assumes all categorical values are numbers!
pID = generatePointID(p);
...
drawnow;
saveas(handle,sprintf('fn_evals%d',numNeighbours),'png');
return
