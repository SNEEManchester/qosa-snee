...
def doExperiment0():
	...
	print optExperimentalLogRoot
	#set up the logger
	startLogger(optExperimentalLogRoot)
	print optExperimentalLogRoot

	#experimentLib.compileQueryPlan(optExperimentalLogRoot, "HAND CODED",optCountCpuCycles, logger)
	experimentLib.runAvrora(optExperimentalLogRoot,optSimulationDuration,optJava5exe,logger)
